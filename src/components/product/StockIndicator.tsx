...
export const StockIndicator: React.FC<Props> = ({ product }) => {
  ...
  return (
    <div className="uppercase font-mono text-sm font-medium text-gray-500">
      {stockQuantity < 10 && stockQuantity > 0 && <p className='text-orange-500' >Only {stockQuantity} left in stock</p>}
      {(stockQuantity === 0 || !stockQuantity) && <p className='text-destructive' >Out of stock</p>}
    </div>
  )
}
